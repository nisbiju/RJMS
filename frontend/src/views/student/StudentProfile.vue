  ...
  <div>
    ...
    <div class="container" style="padding: 40px 20px;">
      <div style="max-width: 600px; margin: 0 auto;">
        <div class="card">
          <h1 style="text-align: center; margin-bottom: 30px;">Student Profile</h1>
          ...
          <div class="form-group">
            ...
            <input v-model="form.student_id" type="text" placeholder="Enter your student ID" />
          </div>
          ...
          <div class="form-group">
            ...
            <input v-model="form.year_of_joining" type="text" placeholder="e.g., 2023" />
          </div>
  ...
  methods: {
    async loadProfile() {
      try {
        ...
        this.form.year_of_joining = this.user.year_of_joining || ''
